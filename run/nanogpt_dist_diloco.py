...
def gen_wandb_name(args):
  name = f"dist_diloco_bs{args.batch_size}_lr{args.lr:.0e}_outer{args.outer_lr:.0e}_H{args.diloco_interval}"
  return name

def arg_parse():
  parser = get_common_parser()
  
  # Override default device to 'mps' for this specific file
  parser.set_defaults(device='mps', minibatch_size=4)
